# Contributing to scitex-storage
...
- Search [existing issues](https://github.com/scitex-ai/scitex-storage/issues)
  before opening a new one.
- Include a minimal reproducible example when reporting bugs.
- Specify your Python version, OS, and `scitex-storage` version.

## Development Setup

```bash
git clone git@github.com:scitex-ai/scitex-storage.git
cd scitex-storage
pip install -e ".[dev]"
```

#!/usr/bin/env bash
# Outer apptainer-exec wrapper for scitex-storage's self-hosted (Spartan) CI.
# Copied verbatim from scitex-ssh's .github/ci/exec-in-sif.sh (the fleet's
# established sibling convention) — no package-specific content in this file.
#
